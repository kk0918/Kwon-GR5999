...
if __name__ == '__main__':
    ...
    if WRITE_NEW_PREPROCESSED_FILM_DF:
        processed_script_df = preprocess_film(movie_dc_before_preprocessing_df, 'movie_scripts_dc_after_preprocessing_df', out_path, gre_words)
    ...
    if TUNE_RF_MODEL:
        tuned_rf_no_lex_model = tune_rf_model(df_with_no_lexical_features, df_with_features_and_target_no_lexical.binary_fresh_rotten,
                                       X_train_initial, y_train_initial, False)
